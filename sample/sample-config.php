	...
	$sections[] = array(
		...
		'fields' => array(
			...
			array(
				...
				'desc'=> __('JQuery UI spinner description. Min: 1, max: 500, step: 3, default value: 45', 'redux-framework'),
				"default" 	=> "45",
				"min" 		=> "1",
				"step"		=> "3",
				"max" 		=> "500",
			...
			array(
				'id'=>'spinner2',
				'type' => 'spinner', 
				'title' => __('JQuery UI Spinner Example 2 w/ Steps (5)', 'redux-framework'),
				'desc'=> __('JQuery UI spinner description. Min: 0, max: 300, step: 5, default value: 75', 'redux-framework'),
				"default" 	=> "75",
				"min" 		=> "0",
				"step"		=> "5",
				"max" 		=> "300",
